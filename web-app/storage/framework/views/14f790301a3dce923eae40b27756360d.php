                ...
                <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                    ...
                    <main class="mt-6">
                        <div class="container centered-form">
                            <form id="uploadForm" action="<?php echo e(route('upload.image')); ?>" method="POST" enctype="multipart/form-data">
                                <?php echo csrf_field(); ?>
                                ...
                                <div class="button-group buttons">
                                    <div class="column">
                                        <button type="button" class="btn btn-custom" id="linearModelClassification">Linear Model Classification</button>
                                        <button type="button" class="btn btn-custom"  id="mlpClassification">MLP Classification</button>
                                        <button type="button" class="btn btn-custom" id="rbfClassification">RBF Classification</button>
                            ...
                            <div class="image-section-1">
                                <?php if(session('image')): ?>
                                    <div>
                                        <img src="<?php echo e(asset('storage/' . session('image'))); ?>" alt="Uploaded Image">
                                    </div>
                                <?php endif; ?>
                            </div>
...
<?php /**PATH C:\MAMP\htdocs\web-app\resources\views/image-classification.blade.php ENDPATH**/ ?>