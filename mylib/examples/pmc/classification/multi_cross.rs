...
fn main() {
    ...
    let c_log_filename = CString::new("clf_multi_cross").expect("CString::new failed");
    let c_model_filename = CString::new("../models/examples/mlp/classification/multi_cross.json").expect("CString::new failed");
