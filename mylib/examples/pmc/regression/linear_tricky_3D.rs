...
fn main() {
    ...
    let c_log_filename = CString::new("rg_linear_tricky_3D").expect("CString::new failed");
    let c_model_filename = CString::new("../models/examples/mlp/classification/linear_tricky_3D.json").expect("CString::new failed");
