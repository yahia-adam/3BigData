...
fn main() {
    ...
    let c_log_filename = CString::new("rg_linear_simple_2D").expect("CString::new failed");
    let c_model_filename = CString::new("../models/examples/mlp/classification/linear_simple_2D.json").expect("CString::new failed");
